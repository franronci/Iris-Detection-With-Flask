...
def return_pred(model, scaler, sample_json):
...
flower_model = load_model("final_iris_model_mine.h5")
flower_scaler = joblib.load("iris_scaler_mine.pkl")
...
def prediction():
    ...
    results = return_pred(flower_model, flower_scaler, content)
